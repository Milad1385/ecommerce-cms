  ...
  return (
    <div>
      <form className="border border-[#ebedf2] dark:border-[#191e3a] rounded-md p-4 mb-5 bg-white dark:bg-black">
        <h6 className="text-lg font-bold mb-5">Create new Article</h6>
        <div className="flex flex-col sm:flex-row">
          <div className="flex-1 grid grid-cols-1 sm:grid-cols-2 gap-5">
            <div>
              <label htmlFor="name">Title</label>
              <input id="name" type="text" placeholder="Article Title" className="form-input" />
            </div>
            <div>
              <label htmlFor="profession">Link</label>
              <input id="profession" type="text" placeholder="Article Link" className="form-input" />
            </div>
